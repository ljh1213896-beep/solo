...
OUTPUT = ROOT / "public" / "projects" / "digital-nomad-walkthrough.mp4"
PREVIEW_DIR = ROOT / "public" / "projects" / "digital-nomad-video"

# Move from the collaborative work area to the open atrium, then into the
# softer lounge zone to create a clear spatial journey.
SOURCES = [
    Path(r"D:\Users\4lx\Desktop\1111\1.png"),
    Path(r"D:\Users\4lx\Desktop\1111\2.png"),
    Path(r"D:\Users\4lx\Desktop\1111\3.png"),
]
...
def render_view(image: Image.Image, scene: int, progress: float) -> Image.Image:
    ...
    # Slow architectural movements preserve the vertical columns and green
    # roof trusses while guiding the eye through each functional zone.
    moves = [
        ((0.48, 0.51), (0.53, 0.52), (1.00, 0.86)),
        ((0.43, 0.51), (0.55, 0.50), (0.96, 0.84)),
        ((0.57, 0.52), (0.45, 0.49), (0.95, 0.84)),
    ]
